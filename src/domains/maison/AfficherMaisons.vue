<script setup lang="ts">
  ...
  import type {MaisonDto} from '~/domains/maison/dto/maison.dto'
  import type {PaginedQuery} from '~/types/paginedQuery'
  import FamilyTree from '@balkangraph/familytree.js'
  import type {FamilyMember} from '~/domains/maison/entities/familyMember'
  ...
  const {data: response} = useFetchService<PaginedQuery<MaisonDto>>(API.maison)
